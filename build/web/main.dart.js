...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    "^": ""
  }], ["", "lib/model/gameObjects/Air.dart",, Y, {
    "^": "",
    Air: {
      "^": "GameObject;level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
  }], ["", "lib/model/gameObjects/Brick.dart",, X, {
    "^": "",
    Brick: {
      "^": "GameObject;level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
  }], ["", "lib/model/gameObjects/moveableGameObjects/Enemy.dart",, R, {
    "^": "",
    Enemy_getEnemyByPosition: function(level, y, x) {
      var t1, t2, _i, enemy;
      for (t1 = level.enemys, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
        enemy = t1[_i];
        if (J.$eq$(enemy.positionX, x) && J.$eq$(enemy.positionY, y))
          return enemy;
      }
      return;
    },
  ...
  }], ["", "lib/model/behaviors/move/EnemyMove.dart",, L, {
    "^": "",
    EnemyMove: {
      "^": "IMoveBehavior;",
      move$1: function(mgo) {
        ...
        if (t2 >>> 0 !== t2 || t2 >= t1.length)
          return H.ioore(t1, t2);
        t2 = t1[t2];
        t1 = J.$add$ns(mgo.positionX, mgo.direction);
        if (t1 >>> 0 !== t1 || t1 >= t2.length)
          return H.ioore(t2, t1);
        t1 = t2[t1].isPassable;
        t2 = mgo.direction;
        if (t1)
          mgo.desiredX = J.$add$ns(mgo.desiredX, t2);
        else
          mgo.direction = t2 * -1;
      }
    }
  }], ["", "lib/model/behaviors/move/FastMove.dart",, O, {
    "^": "",
    FastMove: {
      "^": "IMoveBehavior;",
      move$1: function(mgo) {
        mgo.desiredX = J.$add$ns(mgo.desiredX, mgo.direction * 2);
      }
    }
  }], ["", "lib/controller/GameController.dart",, A, {
    "^": "",
    GameController: {
      "^": "Object;view,level,updateTimer,updateCnt,paused,powerUpSubscription",
      update$0: function() {
        var t1, t2, t3, _i, projectile, t4, t5, enemy;
        if (this.paused)
          return;
        ++this.updateCnt;
        for (t1 = this.level, t2 = t1.projectiles, t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
          projectile = t2[_i];
          t4 = this.updateCnt;
          t5 = projectile.movementSpeed;
          if (typeof t5 !== "number")
            return H.iae(t5);
          if (C.JSInt_methods.$mod(t4, t5) === 0)
            if (!t1.gameOver)
              this.moveObject$1(projectile);
        }
        t2 = this.updateCnt;
        t3 = t1.player;
        t4 = t3.movementSpeed;
        if (typeof t4 !== "number")
          return H.iae(t4);
        if (C.JSInt_methods.$mod(t2, t4) === 0)
          if (!t1.gameOver)
            this.moveObject$1(t3);
        for (t2 = t1.enemys, t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
          enemy = t2[_i];
          t4 = this.updateCnt;
          t5 = enemy.movementSpeed;
          if (typeof t5 !== "number")
            return H.iae(t5);
          if (C.JSInt_methods.$mod(t4, t5) === 0)
            if (!t1.gameOver)
              this.moveObject$1(enemy);
        }
        if (!t1.gameOver)
          this.view.updateGamefield$2(t1, t1.player);
      },
      checkPowerUp$1: function(mgo) {
        var t1, t2, t3, _i, powerUpBlock;
        if (mgo.tag !== "player")
          return false;
        for (t1 = this.level, t2 = t1.powerUps, t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
          powerUpBlock = t2[_i];
          if (J.$eq$(powerUpBlock.positionX, mgo.positionX) && J.$eq$(powerUpBlock.positionY, mgo.positionY)) {
            if (t1.player.powerUp === C.PowerUp_4) {
              this.setPowerUp$0();
              return true;
            }
            return false;
      ...
      activatePowerUp$2: function($event, powerUp) {
        var t1, t2, t3, t4, t5, t6;
        switch (powerUp) {
          case C.PowerUp_1:
            this.powerUpSubscription.cancel$0();
            this.view.activatePowerUp$1(powerUp);
            this.level.player.jumpBehavior = new Z.HighJump();
            P.Timer_Timer(C.Duration_2500000, new A.GameController_activatePowerUp_closure(this, powerUp));
            break;
          case C.PowerUp_0:
            this.powerUpSubscription.cancel$0();
            this.view.activatePowerUp$1(powerUp);
            this.level.player.moveBehavior = new O.FastMove();
            P.Timer_Timer(C.Duration_2500000, new A.GameController_activatePowerUp_closure0(this, powerUp));
            break;
          case C.PowerUp_2:
            this.powerUpSubscription.cancel$0();
            t1 = this.level;
            t2 = t1.player;
            t2.attackBehavior = new D.ProjectileAttack();
            t3 = t2.level;
            t4 = J.$add$ns(t2.positionX, t2.direction);
            t5 = t2.positionY;
            t6 = t2.direction;
            t6 = new K.Projectile(J.$tdiv$n(t2.movementSpeed, 2), false, false, null, new Y.ProjectileMove(), null, null, null, null, t6, t3, t4, t5, false, true, false, "projectile");
            if (t3 != null) {
              t2 = t3.field;
            ...
            t6.desiredY = t5;
            t6.desiredX = t4;
            t6.currentStaticObject = new Y.Air(null, t4, t5, true, false, false, "air");
            t3.projectiles.push(t6);
            t1.player.attackBehavior = null;
            this.removePowerUp$1(powerUp);
            break;
          case C.PowerUp_3:
            break;
          case C.PowerUp_4:
      ...
      setPowerUp$0: function() {
        ...
        switch (powerUp) {
          case C.PowerUp_1:
            this.view.setPowerUp$1(C.PowerUp_1);
            this.level.player.powerUp = C.PowerUp_1;
            t1 = J.get$onClick$x(this.view.powerUpButton);
            this.powerUpSubscription = W._EventStreamSubscription$(t1._html$_target, t1._eventType, new A.GameController_setPowerUp_closure(this), false, H.getTypeArgumentByIndex(t1, 0));
            break;
          case C.PowerUp_0:
            this.view.setPowerUp$1(C.PowerUp_0);
            this.level.player.powerUp = C.PowerUp_0;
            t1 = J.get$onClick$x(this.view.powerUpButton);
            this.powerUpSubscription = W._EventStreamSubscription$(t1._html$_target, t1._eventType, new A.GameController_setPowerUp_closure0(this), false, H.getTypeArgumentByIndex(t1, 0));
            break;
          case C.PowerUp_2:
            this.view.setPowerUp$1(C.PowerUp_2);
            this.level.player.powerUp = C.PowerUp_2;
            t1 = J.get$onClick$x(this.view.powerUpButton);
            this.powerUpSubscription = W._EventStreamSubscription$(t1._html$_target, t1._eventType, new A.GameController_setPowerUp_closure1(this), false, H.getTypeArgumentByIndex(t1, 0));
            break;
          case C.PowerUp_3:
            this.view.setPowerUp$1(C.PowerUp_3);
            t1 = this.level.player;
            t1.powerUp = C.PowerUp_3;
            t1.secondLife = true;
            break;
          case C.PowerUp_4:
            break;
      ...
      removePowerUp$1: function(powerUp) {
        var t1;
        this.view.setPowerUp$1(C.PowerUp_4);
        t1 = this.level.player;
        t1.powerUp = C.PowerUp_4;
        switch (powerUp) {
          case C.PowerUp_1:
            t1.jumpBehavior = new N.SimpleJump();
            break;
          case C.PowerUp_0:
            t1.moveBehavior = new Z.SimpleMove();
            break;
          case C.PowerUp_2:
            break;
          case C.PowerUp_3:
      ...
      handleY$1: function(mgo) {
        var desiredY, oldY, t1, t2, t3, y, t4, o;
        desiredY = mgo.desiredY;
        oldY = mgo.positionY;
        t1 = J.getInterceptor(oldY);
        if (t1.$eq(oldY, desiredY) && mgo.hasGravity) {
          mgo.positionY = J.$add$ns(mgo.positionY, 1);
          this.traps$1(mgo);
          if (this.checkLost$1(mgo))
            return;
          if (this.checkWin$1(mgo))
            return;
          this.checkPowerUp$1(mgo);
          t1 = this.level.field;
          t2 = mgo.positionY;
          if (t2 >>> 0 !== t2 || t2 >= t1.length)
            return H.ioore(t1, t2);
          ...
          for (y = t1.$sub(oldY, 1), t1 = this.level; J.$ge$n(y, desiredY); --y) {
            mgo.positionY = y;
            if (this.checkLost$1(mgo))
              return;
            if (this.checkWin$1(mgo))
        ...
        if (!J.$eq$(t1, oldY)) {
          ...
          o = t2[t4];
          t2[t4] = mgo;
          if (oldY >>> 0 !== oldY || oldY >= t3)
            return H.ioore(t1, oldY);
          t1 = t1[oldY];
          t3 = mgo.currentStaticObject;
          if (t4 >= t1.length)
      ...
      handleX$1: function(mgo) {
        var desiredX, oldX, x, t1, t2, t3, t4, o;
        desiredX = mgo.desiredX;
        oldX = mgo.positionX;
        if (mgo.direction > 0)
          for (x = J.$add$ns(oldX, 1), t1 = this.level; J.$le$n(x, desiredX); ++x) {
            mgo.positionX = x;
            if (this.checkLost$1(mgo))
              return;
            if (this.checkWin$1(mgo))
            ...
            if (x >>> 0 !== x || x >= t3.length)
              return H.ioore(t3, x);
            if (!t3[x].isPassable) {
              mgo.positionX = J.$sub$n(mgo.positionX, 1);
              break;
            }
          }
        if (mgo.direction < 0)
          for (x = J.$sub$n(oldX, 1), t1 = this.level; J.$ge$n(x, desiredX); --x) {
            mgo.positionX = x;
            if (this.checkLost$1(mgo))
              return;
            if (this.checkWin$1(mgo))
            ...
            if (x >>> 0 !== x || x >= t3.length)
              return H.ioore(t3, x);
            if (!t3[x].isPassable) {
              mgo.positionX = J.$add$ns(mgo.positionX, 1);
              break;
            }
          }
        t1 = mgo.positionX;
        ...
        if (!J.$eq$(t1, oldX)) {
          ...
          t3[t4] = mgo;
          t2 = t1[t2];
          t1 = mgo.currentStaticObject;
          if (oldX >>> 0 !== oldX || oldX >= t2.length)
            return H.ioore(t2, oldX);
          t2[oldX] = t1;
          mgo.currentStaticObject = o;
        }
      },
      traps$1: function(mgo) {
        var enemy;
        if (mgo.tag !== "player")
          return;
        enemy = R.Enemy_getEnemyByPosition(this.level, mgo.positionY, mgo.positionX);
        if (!(enemy == null))
          enemy.destroy$0();
      },
      checkLost$1: function(mgo) {
        var t1, t2, t3, t4;
        t1 = this.level;
        t2 = t1.field;
        t3 = t2.length;
        ...
        if (t2)
          if (mgo.tag === "player") {
            t1.gameOver = true;
            this.view.setPowerUp$1(C.PowerUp_4);
            this.view.showLost$0();
            this.updateTimer.cancel$0();
            return true;
          } else {
            mgo._isDestroyed = true;
            t2 = mgo.level.field;
            t3 = mgo.positionY;
            if (t3 >>> 0 !== t3 || t3 >= t2.length)
              return H.ioore(t2, t3);
        ...
        if (t2.isDeathly)
          if (mgo.tag === "player")
            if (!t1.player.secondLife) {
              ...
              this.traps$1(mgo);
              this.removePowerUp$1(C.PowerUp_3);
            }
          else {
            mgo._isDestroyed = true;
            t1 = mgo.level.field;
      ...
      checkWin$1: function(mgo) {
        ...
        if (t3[t2].isGoal) {
          ...
          this.view.setPowerUp$1(C.PowerUp_4);
          t1 = this.view;
          t1.isGameActive = false;
          t2 = t1.gameField;
          t3 = t2.style;
          t3.zIndex = "1";
          t3 = t1.levelSelectDiv;
          t4 = t3.style;
          t4.zIndex = "0";
          t4 = t1.successScreen;
          t5 = t4.style;
      ...
      GameController$2: function(view, level) {
        var t1;
        this.view.initGameField$0();
        t1 = J.get$onClick$x(this.view.jumpButton);
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, new A.GameController_closure(this), false, H.getTypeArgumentByIndex(t1, 0));
        t1 = this.updateTimer;
        if (t1 != null)
          t1.cancel$0();
        this.updateTimer = P.Timer_Timer$periodic(C.Duration_1000, new A.GameController_closure0(this));
      },
      static: {
        GameController$: function(view, level) {
          var t1 = new A.GameController(view, level, null, 0, false, null);
          t1.GameController$2(view, level);
          return t1;
        }
      }
    },
    ...
    GameController_activatePowerUp_closure: {
      "^": "Closure:0;$this,powerUp",
      call$0: function() {
        return this.$this.removePowerUp$1(this.powerUp);
      }
    },
    GameController_activatePowerUp_closure0: {
      "^": "Closure:0;$this,powerUp",
      call$0: function() {
        return this.$this.removePowerUp$1(this.powerUp);
      }
    },
    GameController_setPowerUp_closure: {
      "^": "Closure:5;$this",
      call$1: function($event) {
        return this.$this.activatePowerUp$2($event, C.PowerUp_1);
      }
    },
    GameController_setPowerUp_closure0: {
      "^": "Closure:5;$this",
      call$1: function($event) {
        return this.$this.activatePowerUp$2($event, C.PowerUp_0);
      }
    },
    GameController_setPowerUp_closure1: {
      "^": "Closure:5;$this",
      call$1: function($event) {
        return this.$this.activatePowerUp$2($event, C.PowerUp_2);
      }
    }
  }], ["", "lib/model/gameObjects/GameObject.dart",, N, {
    "^": "",
    GameObject: {
      "^": "Object;"
    }
  }], ["", "lib/view/GameView.dart",, L, {
    "^": "",
    GameView: {
      "^": "Object;levelSelectDiv,successScreen,failureScreen,gameField,pauseScreen,powerUpLabel,creditsScreen,levelSelectButtons,backToMenuFromSuccess,backToMenuFromFailure,nextLevel,retryLevel,btnCreditsScreen,backToMenuFromCredis,jumpButton,powerUpButton,menuController,gameController,iWidth,iHeight,width,height,fields,isGameActive",
      activatePowerUp$1: function(powerUp) {
        var t1;
        switch (powerUp) {
          case C.PowerUp_1:
            t1 = this.powerUpLabel.style;
            t1.backgroundImage = "url(../../img/PowerUps/higherJumpActivatedPowerUp.png)";
            break;
          case C.PowerUp_0:
            t1 = this.powerUpLabel.style;
            t1.backgroundImage = "url(../../img/PowerUps/speedActivatedPowerUp.png)";
            break;
          case C.PowerUp_2:
            break;
          case C.PowerUp_3:
      ...
      setPowerUp$1: function(powerUp) {
        var t1;
        switch (powerUp) {
          case C.PowerUp_1:
            t1 = this.powerUpLabel.style;
            t1.backgroundImage = "url(../../img/PowerUps/higherJumpPowerUp.png)";
            break;
          case C.PowerUp_0:
            t1 = this.powerUpLabel.style;
            t1.backgroundImage = "url(../../img/PowerUps/speedPowerUp.png)";
            break;
          case C.PowerUp_2:
            t1 = this.powerUpLabel.style;
            t1.backgroundImage = "url(../../img/PowerUps/fireActivatedPowerUp.png)";
            break;
          case C.PowerUp_3:
            t1 = this.powerUpLabel.style;
            t1.backgroundImage = "url(../../img/PowerUps/secondLifePowerUp.png)";
            break;
          case C.PowerUp_4:
            t1 = this.powerUpLabel.style;
            t1.backgroundImage = "url(../../img/PowerUps/noPowerUp.png)";
            break;
        }
      },
      reload$0: function(_) {
        ...
        if (typeof t2 !== "number")
          return H.iae(t2);
        this.width = C.JSDouble_methods.round$0(t1 / t2 * this.height);
        this.initGameField$0();
      },
      initGameField$0: function() {
        var table, row, col, t1, t2;
        for (table = "", row = 0; row < this.height; ++row) {
          table += "<tr>";
          col = 0;
          while (true) {
            t1 = this.width;
        ...
        this.fields = H.setRuntimeTypeInfo(new Array(this.height), [[P.List, W.HtmlElement]]);
        for (row = 0; row < this.height; ++row) {
          ...
          while (true) {
            ...
            if (row >= t2.length)
              return H.ioore(t2, row);
            t2[row].push(t1.querySelector("#field_" + col + "_" + row));
            ++col;
          }
        }
      },
      updateGamefield$2: function(level, player) {
        var field, fieldHeight, t1, fieldWidth, t2, playerX, playerY, t3, t4, t5, t6, rowStart, retVal, rowEnd, colEnd, col, row, td;
        field = level.field;
        fieldHeight = field == null ? field : field.length;
        t1 = field.length;
        if (0 >= t1)
          return H.ioore(field, 0);
        fieldWidth = field[0];
        fieldWidth = fieldWidth == null ? fieldWidth : fieldWidth.length;
        t2 = player == null;
        playerX = t2 ? player : player.positionX;
        playerY = t2 ? player : player.positionY;
        ...
        if (t2 < t3) {
          ...
          t2 = t1.style;
          t2.zIndex = "2";
          t2 = this.successScreen;
          t3 = t2.style;
          t3.zIndex = "0";
          t3 = this.failureScreen;
          t4 = t3.style;
          t4.zIndex = "0";
          t4 = this.levelSelectDiv;
          t5 = t4.style;
          t5.zIndex = "0";
          t5 = this.gameField;
          t6 = t5.style;
        ...
        if (fieldHeight === t2)
          ...
          if (typeof fieldHeight !== "number")
            return fieldHeight.$gt();
          if (fieldHeight > t2) {
            t3 = J.getInterceptor$ns(playerY);
            if (J.$gt$n(t3.$add(playerY, t2 / 2 | 0), fieldHeight))
              retVal = fieldHeight - this.height;
            else
              retVal = J.$lt$n(t3.$sub(playerY, this.height / 2 | 0), 0) ? 0 : t3.$sub(playerY, this.height / 2 | 0);
            rowStart = retVal;
          } else
            rowStart = (fieldHeight / 2 | 0) - (t2 / 2 | 0);
        }
        rowEnd = J.$add$ns(rowStart, this.height);
        t2 = field[0].length;
        t3 = this.width;
        if (typeof t3 !== "number")
          return t3.$tdiv();
        t4 = J.getInterceptor$n(playerX);
        if (J.$lt$n(t4.$sub(playerX, C.JSInt_methods._tdivFast$1(t3, 2)), 0))
          retVal = 0;
        else {
          t3 = this.width;
          if (typeof t3 !== "number")
            return t3.$tdiv();
          t3 = J.$gt$n(t4.$add(playerX, C.JSInt_methods._tdivFast$1(t3, 2)), t2);
          t5 = this.width;
          if (t3) {
            if (typeof t5 !== "number")
              return H.iae(t5);
            ...
            if (typeof t5 !== "number")
              return t5.$tdiv();
            retVal = t4.$sub(playerX, C.JSInt_methods._tdivFast$1(t5, 2));
          }
        }
        colEnd = J.$add$ns(retVal, this.width);
        for (col = retVal; t2 = J.getInterceptor$n(col), t2.$lt(col, colEnd); col = t2.$add(col, 1))
          for (row = rowStart; t3 = J.getInterceptor$n(row), t3.$lt(row, rowEnd); row = t3.$add(row, 1)) {
            t4 = this.fields;
            t5 = t3.$sub(row, rowStart);
            if (t5 >>> 0 !== t5 || t5 >= t4.length)
              return H.ioore(t4, t5);
            t5 = t4[t5];
            t4 = t2.$sub(col, retVal);
            ...
            if (t4 != null) {
              ...
              t5 = field[row];
              if (col >>> 0 !== col || col >= t5.length)
                return H.ioore(t5, col);
              t5 = t4 !== t5[col].tag;
              t4 = t5;
            } else
              t4 = true;
            if (t4) {
              ...
              t4.get$classes(td).clear$0(0);
              if (!t3.$lt(row, 0)) {
                if (typeof fieldHeight !== "number")
                  return fieldHeight.$sub();
                if (!t3.$gt(row, fieldHeight - 1))
                  if (!t2.$lt(col, 0)) {
                    if (typeof fieldWidth !== "number")
                      return fieldWidth.$sub();
                    if (!t2.$gt(col, fieldWidth - 1)) {
                      if (row >>> 0 !== row || row >= t1)
                        return H.ioore(field, row);
                      t5 = field[row];
                      if (col >>> 0 !== col || col >= t5.length)
                ...
                t5 = true;
              if (t5)
                t4.get$classes(td).add$1(0, "noneClass");
              else {
                t4 = t4.get$classes(td);
                if (row >>> 0 !== row || row >= t1)
                  return H.ioore(field, row);
                t5 = field[row];
                if (col >>> 0 !== col || col >= t5.length)
                  return H.ioore(t5, col);
                t4.add$1(0, t5[col].tag);
              }
            }
          }
      },
      showLost$0: function() {
        ...
        t2 = t1.style;
        t2.zIndex = "1";
        t2 = this.levelSelectDiv;
        t3 = t2.style;
        t3.zIndex = "0";
        t3 = this.successScreen;
        t4 = t3.style;
        t4.zIndex = "0";
        t4 = this.failureScreen;
        t5 = t4.style;
        t5.zIndex = "2";
        t5 = this.pauseScreen;
        t6 = t5.style;
      ...
      showGame$0: function() {
        ...
        t6 = t5.style;
        t6.zIndex = "0";
        t6 = this.powerUpLabel;
        t7 = t6.style;
        t7.zIndex = "2";
        t7 = this.creditsScreen;
        t8 = t7.style;
        t8.zIndex = "0";
        t7 = t7.style;
        t7.visibility = "hidden";
        t6 = t6.style;
        t6.visibility = "visible";
        t1 = t1.style;
        t1.visibility = "visible";
        t1 = t2.style;
        t1.visibility = "hidden";
      ...
      showMenu$0: function() {
        ...
        t6 = t5.style;
        t6.zIndex = "0";
        t6 = this.creditsScreen;
        t7 = t6.style;
        t7.zIndex = "0";
        t7 = this.powerUpLabel;
        t8 = t7.style;
        t8.zIndex = "0";
        t7 = t7.style;
        t7.visibility = "hidden";
      ...
      GameView$1: function(menuController) {
        var t1, t2, i, button, t3;
        this.reload$0(0);
        t1 = J.get$onClick$x(this.backToMenuFromSuccess);
        t2 = this.menuController;
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, t2.get$triggerBackToMenuFromSuccess(), false, H.getTypeArgumentByIndex(t1, 0));
        t1 = J.get$onClick$x(this.nextLevel);
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, t2.get$triggerNextLevel(), false, H.getTypeArgumentByIndex(t1, 0));
        t1 = J.get$onClick$x(this.backToMenuFromFailure);
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, t2.get$triggerBackToMenuFromFailure(), false, H.getTypeArgumentByIndex(t1, 0));
        t1 = J.get$onClick$x(this.retryLevel);
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, t2.get$triggerRetryLevel(), false, H.getTypeArgumentByIndex(t1, 0));
        t1 = J.get$onClick$x(this.btnCreditsScreen);
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, t2.get$triggerShowCredits(), false, H.getTypeArgumentByIndex(t1, 0));
        t1 = J.get$onClick$x(this.backToMenuFromCredis);
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, t2.get$triggerBackToMenuFromCredits(), false, H.getTypeArgumentByIndex(t1, 0));
        for (t1 = this.levelSelectButtons, i = 1; i <= 15; ++i) {
          t2 = "#button" + i;
          button = document.querySelector(t2);
          t1.push(button);
          t2 = button.style;
          t3 = "url(../../img/LevelButtons/lvl" + i + ".png)";
          t2.backgroundImage = t3;
          t2 = J.get$onClick$x(button);
          W._EventStreamSubscription$(t2._html$_target, t2._eventType, new L.GameView_closure(this, i), false, H.getTypeArgumentByIndex(t2, 0));
        }
      },
      static: {
        GameView$: function(menuController) {
          var t1 = document;
          t1 = new L.GameView(t1.querySelector("#levelSelectDiv"), t1.querySelector("#SuccessScreen"), t1.querySelector("#FailureScreen"), t1.querySelector("#GameField"), t1.querySelector("#PauseScreen"), t1.querySelector("#powerUpLabel"), t1.querySelector("#CreditsScreen"), H.setRuntimeTypeInfo([], [W.ButtonElement]), t1.querySelector("#backToLevelSelect"), t1.querySelector("#backToLevelSelect_Failure"), t1.querySelector("#nextLevel"), t1.querySelector("#retryLevel"), t1.querySelector("#btnCreditsScreen"), t1.querySelector("#backToLevelSelect_Credits"), t1.querySelector("#jumpButton"), t1.querySelector("#powerUpButton"), menuController, null, null, null, null, 10, null, false);
          t1.GameView$1(menuController);
          return t1;
        }
      }
    },
    GameView_closure: {
      ...
      call$1: function($event) {
        var t1, t2;
        t1 = this.$this.menuController;
        t2 = this.i;
        t1.selectedLevel = t2;
        new V.LevelCreator(100, 20, t1.view).load$2(0, t2, t1.get$loadLevel());
        return;
      }
    }
  }], ["", "lib/model/gameObjects/Goal.dart",, U, {
    "^": "",
    Goal: {
      "^": "GameObject;level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
  }], ["", "lib/model/gameObjects/Grass.dart",, D, {
    "^": "",
    Grass: {
      "^": "GameObject;level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
  }], ["", "lib/model/behaviors/jump/HighJump.dart",, Z, {
    "^": "",
    HighJump: {
      "^": "IJumpBehavior;",
      jump$1: function(mgo) {
        ...
        if (t3[t1].isPassable)
          return;
        mgo.desiredY = J.$sub$n(mgo.desiredY, 4);
      }
    }
  }], ["", "lib/model/behaviors/attack/IAttackBehavior.dart",, K, {
    "^": "",
    IAttackBehavior: {
      "^": "Object;"
    }
  }], ["", "lib/model/behaviors/jump/IJumpBehavior.dart",, G, {
    "^": "",
    IJumpBehavior: {
      "^": "Object;"
    }
  }], ["", "lib/model/behaviors/move/IMoveBehavior.dart",, D, {
    "^": "",
    IMoveBehavior: {
      "^": "Object;"
    }
  }], ["", "lib/model/behaviors/move/JumpMove.dart",, V, {
    "^": "",
    JumpMove: {
      "^": "IMoveBehavior;",
      move$1: function(mgo) {
        ...
        if (t1 >>> 0 !== t1 || t1 >= t2.length)
          return H.ioore(t2, t1);
        if (!t2[t1].isPassable)
          mgo.desiredY = J.$sub$n(mgo.desiredY, 5);
      }
    }
  }], ["", "lib/model/gameObjects/moveableGameObjects/Jumper.dart",, V, {
    "^": "",
    Jumper: {
      "^": "Enemy;movementSpeed,_isDestroyed,hasGravity,currentStaticObject,moveBehavior,jumpBehavior,attackBehavior,desiredX,desiredY,direction,level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
  }], ["", "lib/model/Level.dart",, Q, {
    "^": "",
    Level: {
      "^": "Object;field,player,projectiles,enemys,powerUps,gameOver"
    }
  }], ["", "lib/util/LevelCreator.dart",, V, {
    "^": "",
    LevelCreator: {
      "^": "Object;width,height,view",
      load$2: function(_, levelNr, callbackFunction) {
        return W.HttpRequest_getString("../../levels/level_" + H.S(levelNr) + ".json", null, null).then$1(new V.LevelCreator_load_closure(this, callbackFunction));
      },
      levelFromMap$1: function(data) {
        var t1, t2, t3, t4, level, field, row, col, t5;
        t1 = this.view;
        t2 = J.getInterceptor$asx(data);
        t3 = J.$index$asx(t2.$index(data, "background"), "image") == null ? "grasslands" : J.$index$asx(t2.$index(data, "background"), "image");
        t1 = t1.gameField;
        t4 = t1.style;
        t3 = "url(../../img/LevelBackgrounds/" + H.S(t3) + ".png)";
        t4.background = t3;
        t1 = t1.style;
        C.CssStyleDeclaration_methods._setPropertyHelper$3(t1, (t1 && C.CssStyleDeclaration_methods)._browserPropertyName$1(t1, "background-size"), "cover", "");
        if (t2.$index(data, "size") != null)
          J.forEach$1$ax(t2.$index(data, "size"), new V.LevelCreator_levelFromMap_closure(this));
        level = new Q.Level(null, null, H.setRuntimeTypeInfo([], [K.Projectile]), H.setRuntimeTypeInfo([], [R.Enemy]), H.setRuntimeTypeInfo([], [L.PowerUpBlock]), false);
        t1 = this.height;
        if (typeof t1 !== "number")
          return H.iae(t1);
        field = H.setRuntimeTypeInfo(new Array(t1), [[P.List, N.GameObject]]);
        t1 = [N.GameObject];
        t3 = field.length;
        row = 0;
        while (true) {
          ...
          if (typeof t4 !== "number")
            return H.iae(t4);
          t4 = H.setRuntimeTypeInfo(new Array(t4), t1);
          if (row >= t3)
            return H.ioore(field, row);
          field[row] = t4;
          ++row;
        ...
        level.field = field;
        for (t1 = this.width, t3 = level.field, row = 0; row < t4; ++row) {
          if (typeof t1 !== "number")
            return H.iae(t1);
          col = 0;
          for (; col < t1; ++col) {
            t5 = t3.length;
            if (row >= t5)
              return H.ioore(t3, row);
            t5 = t3[row];
            if (col >= t5.length)
              return H.ioore(t5, col);
            t5[col] = new Y.Air(level, col, row, true, false, false, "air");
          }
        }
        if (t2.$index(data, "grass") != null)
          J.forEach$1$ax(t2.$index(data, "grass"), new V.LevelCreator_levelFromMap_closure0(this, level));
        if (t2.$index(data, "brick") != null)
          J.forEach$1$ax(t2.$index(data, "brick"), new V.LevelCreator_levelFromMap_closure1(this, level));
        if (t2.$index(data, "goal") != null)
          J.forEach$1$ax(t2.$index(data, "goal"), new V.LevelCreator_levelFromMap_closure2(this, level));
        if (t2.$index(data, "powerUp") != null)
          J.forEach$1$ax(t2.$index(data, "powerUp"), new V.LevelCreator_levelFromMap_closure3(this, level));
        if (t2.$index(data, "walker") != null)
          J.forEach$1$ax(t2.$index(data, "walker"), new V.LevelCreator_levelFromMap_closure4(this, level));
        if (t2.$index(data, "jumper") != null)
          J.forEach$1$ax(t2.$index(data, "jumper"), new V.LevelCreator_levelFromMap_closure5(this, level));
        if (t2.$index(data, "slime") != null)
          J.forEach$1$ax(t2.$index(data, "slime"), new V.LevelCreator_levelFromMap_closure6(this, level));
        if (t2.$index(data, "player") != null)
          J.forEach$1$ax(t2.$index(data, "player"), new V.LevelCreator_levelFromMap_closure7(this, level));
        if (t2.$index(data, "air") != null)
          J.forEach$1$ax(t2.$index(data, "air"), new V.LevelCreator_levelFromMap_closure8(this, level));
        return level;
      },
      setAir$3: function(level, y, x) {
        var t1, _i, t2, t3, t4, t5;
        for (t1 = x.length, _i = 0; _i < x.length; x.length === t1 || (0, H.throwConcurrentModificationError)(x), ++_i) {
          t2 = H.Primitives_parseInt(x[_i], null, null);
          t3 = H.Primitives_parseInt(y, null, null);
          t4 = level.field;
          t5 = t4.length;
          if (t3 >>> 0 !== t3 || t3 >= t5)
            return H.ioore(t4, t3);
          ...
          t4[t2] = new Y.Air(level, t2, t3, true, false, false, "air");
        }
      },
      setPowerUp$3: function(level, y, x) {
        var t1, _i, t2, t3, t4, t5, t6;
        for (t1 = x.length, _i = 0; _i < x.length; x.length === t1 || (0, H.throwConcurrentModificationError)(x), ++_i) {
          t2 = H.Primitives_parseInt(x[_i], null, null);
          t3 = H.Primitives_parseInt(y, null, null);
          t4 = new L.PowerUpBlock(level, t2, t3, true, false, false, "powerUpBlock");
          t5 = level.field;
          t6 = t5.length;
          if (t3 >>> 0 !== t3 || t3 >= t6)
          ...
          if (t2 >>> 0 !== t2 || t2 >= t3.length)
            return H.ioore(t3, t2);
          t3[t2] = t4;
          level.powerUps.push(t4);
        }
      },
      fillWithBricks$2: function(level, y) {
        var i, t1, t2, t3;
        i = 0;
        while (true) {
          t1 = this.width;
          ...
          if (!(i < t1))
            break;
          t1 = H.Primitives_parseInt(y, null, null);
          t2 = level.field;
          t3 = t2.length;
          if (t1 >>> 0 !== t1 || t1 >= t3)
            return H.ioore(t2, t1);
          ...
          if (i >= t2.length)
            return H.ioore(t2, i);
          t2[i] = new X.Brick(level, i, t1, false, false, false, "brick");
          ++i;
        }
      },
      setBricks$3: function(level, y, x) {
        var t1, _i, t2, t3, t4, t5;
        for (t1 = x.length, _i = 0; _i < x.length; x.length === t1 || (0, H.throwConcurrentModificationError)(x), ++_i) {
          t2 = H.Primitives_parseInt(x[_i], null, null);
          t3 = H.Primitives_parseInt(y, null, null);
          ...
          if (t2 >>> 0 !== t2 || t2 >= t4.length)
            return H.ioore(t4, t2);
          t4[t2] = new X.Brick(level, t2, t3, false, false, false, "brick");
        }
      },
      fillWithGrass$2: function(level, y) {
        var i, t1, t2, t3;
        i = 0;
        while (true) {
          t1 = this.width;
          ...
          if (i >= t2.length)
            return H.ioore(t2, i);
          t2[i] = new D.Grass(level, i, t1, false, false, false, "grass");
          ++i;
        }
      },
      setGrass$3: function(level, y, x) {
        var t1, _i, t2, t3, t4, t5;
        for (t1 = x.length, _i = 0; _i < x.length; x.length === t1 || (0, H.throwConcurrentModificationError)(x), ++_i) {
          t2 = H.Primitives_parseInt(x[_i], null, null);
          t3 = H.Primitives_parseInt(y, null, null);
          ...
          if (t2 >>> 0 !== t2 || t2 >= t4.length)
            return H.ioore(t4, t2);
          t4[t2] = new D.Grass(level, t2, t3, false, false, false, "grass");
        }
      },
      setGoal$3: function(level, y, x) {
        var t1, _i, t2, t3, t4, t5;
        for (t1 = x.length, _i = 0; _i < x.length; x.length === t1 || (0, H.throwConcurrentModificationError)(x), ++_i) {
          t2 = H.Primitives_parseInt(x[_i], null, null);
          t3 = H.Primitives_parseInt(y, null, null);
          ...
          if (t2 >>> 0 !== t2 || t2 >= t4.length)
            return H.ioore(t4, t2);
          t4[t2] = new U.Goal(level, t2, t3, false, false, true, "goal");
        }
      },
      setWalker$3: function(level, y, x) {
        var t1, t2, t3, _i, v, z, t4, t5, t6, t7, t8;
        for (t1 = x.length, t2 = J.getInterceptor(y), t3 = level.enemys, _i = 0; _i < x.length; x.length === t1 || (0, H.throwConcurrentModificationError)(x), ++_i) {
          v = x[_i];
          if (!J.$eq$(t2.toString$0(y), "speed")) {
            z = J.split$1$s(J.toString$0$(v), ";");
            if (z.length < 2) {
              t4 = H.Primitives_parseInt(z[0], null, null);
              t5 = H.Primitives_parseInt(y, null, null);
              t6 = new D.Walker(200, false, true, null, new L.EnemyMove(), null, null, null, null, -1, level, t4, t5, false, true, false, "walker");
              t7 = level.field;
              t8 = t7.length;
              if (t5 >>> 0 !== t5 || t5 >= t8)
              ...
              if (1 >= z.length)
                return H.ioore(z, 1);
              t6 = new D.Walker(H.Primitives_parseInt(z[1], null, null), false, true, null, new L.EnemyMove(), null, null, null, null, -1, level, t4, t5, false, true, false, "walker");
              t7 = level.field;
              t8 = t7.length;
              if (t5 >>> 0 !== t5 || t5 >= t8)
                return H.ioore(t7, t5);
      ...
      setJumper$3: function(level, y, x) {
        var t1, t2, _i, z, t3, t4, t5, t6, t7;
        for (t1 = x.length, t2 = level.enemys, _i = 0; _i < x.length; x.length === t1 || (0, H.throwConcurrentModificationError)(x), ++_i) {
          z = J.split$1$s(J.toString$0$(x[_i]), ";");
          if (z.length < 2) {
            t3 = H.Primitives_parseInt(z[0], null, null);
            t4 = H.Primitives_parseInt(y, null, null);
            t5 = new V.Jumper(200, false, true, null, new V.JumpMove(), null, null, null, null, 0, level, t3, t4, false, true, false, "jumper");
            t6 = level.field;
            t7 = t6.length;
            if (t4 >>> 0 !== t4 || t4 >= t7)
            ...
            t5.desiredY = t4;
            t5.desiredX = t3;
            t5.currentStaticObject = new Y.Air(null, t3, t4, true, false, false, "air");
            t2.push(t5);
          } else {
            t3 = H.Primitives_parseInt(z[0], null, null);
            t4 = H.Primitives_parseInt(y, null, null);
            if (1 >= z.length)
              return H.ioore(z, 1);
            t5 = new V.Jumper(H.Primitives_parseInt(z[1], null, null), false, true, null, new V.JumpMove(), null, null, null, null, 0, level, t3, t4, false, true, false, "jumper");
            t6 = level.field;
            t7 = t6.length;
            if (t4 >>> 0 !== t4 || t4 >= t7)
              return H.ioore(t6, t4);
      ...
      setSlime$3: function(level, y, x) {
        var t1, t2, _i, t3, t4, t5, t6, t7;
        for (t1 = x.length, t2 = level.enemys, _i = 0; _i < x.length; x.length === t1 || (0, H.throwConcurrentModificationError)(x), ++_i) {
          t3 = H.Primitives_parseInt(x[_i], null, null);
          t4 = H.Primitives_parseInt(y, null, null);
          t5 = new D.Slime(0, false, false, null, null, null, null, null, null, 0, level, t3, t4, false, true, false, "slime");
          t6 = level.field;
          t7 = t6.length;
          if (t4 >>> 0 !== t4 || t4 >= t7)
            return H.ioore(t6, t4);
      ...
      setPlayer$3: function(level, y, x) {
        var t1, _i, z, t2, t3, t4, t5, t6;
        for (t1 = x.length, _i = 0; _i < x.length; x.length === t1 || (0, H.throwConcurrentModificationError)(x), ++_i) {
          z = J.split$1$s(J.toString$0$(x[_i]), ";");
          if (z.length < 2) {
            t2 = H.Primitives_parseInt(z[0], null, null);
            t3 = H.Primitives_parseInt(y, null, null);
            t4 = new R.Player(false, C.PowerUp_4, 100, false, true, null, new Z.SimpleMove(), new N.SimpleJump(), null, null, null, 1, level, t2, t3, true, false, false, "player");
            t5 = level.field;
            t6 = t5.length;
            if (t3 >>> 0 !== t3 || t3 >= t6)
              return H.ioore(t5, t3);
            ...
            t4.desiredY = t3;
            t4.desiredX = t2;
            t4.currentStaticObject = new Y.Air(null, t2, t3, true, false, false, "air");
            level.player = t4;
          } else {
            t2 = H.Primitives_parseInt(z[0], null, null);
            t3 = H.Primitives_parseInt(y, null, null);
            if (1 >= z.length)
              return H.ioore(z, 1);
            t4 = new R.Player(false, C.PowerUp_4, H.Primitives_parseInt(z[1], null, null), false, true, null, new Z.SimpleMove(), new N.SimpleJump(), null, null, null, 1, level, t2, t3, true, false, false, "player");
            t5 = level.field;
            t6 = t5.length;
            if (t3 >>> 0 !== t3 || t3 >= t6)
              return H.ioore(t5, t3);
    ...
    LevelCreator_load_closure: {
      "^": "Closure:1;$this,callbackFunction",
      call$1: function(lvlJson) {
        this.callbackFunction.call$1(this.$this.levelFromMap$1(C.JsonCodec_null_null.decode$1(lvlJson)));
      }
    },
    LevelCreator_levelFromMap_closure: {
      "^": "Closure:3;$this",
      call$2: function(k, v) {
        var t1 = this.$this;
        t1.height = H.Primitives_parseInt(k, null, null);
        t1.width = H.Primitives_parseInt(v, null, null);
        return;
      }
    },
    LevelCreator_levelFromMap_closure0: {
      "^": "Closure:3;$this,level",
      call$2: function(k, v) {
        var t1, t2, t3;
        t1 = J.getInterceptor(v);
        t2 = this.$this;
        t3 = this.level;
        return t1.$eq(v, "all") ? t2.fillWithGrass$2(t3, k) : t2.setGrass$3(t3, k, J.split$1$s(t1.toString$0(v), ","));
      }
    },
    LevelCreator_levelFromMap_closure1: {
      "^": "Closure:3;$this,level",
      call$2: function(k, v) {
        var t1, t2, t3;
        t1 = J.getInterceptor(v);
        t2 = this.$this;
        t3 = this.level;
        return t1.$eq(v, "all") ? t2.fillWithBricks$2(t3, k) : t2.setBricks$3(t3, k, J.split$1$s(t1.toString$0(v), ","));
      }
    },
    LevelCreator_levelFromMap_closure2: {
      "^": "Closure:3;$this,level",
      call$2: function(k, v) {
        return this.$this.setGoal$3(this.level, k, J.split$1$s(J.toString$0$(v), ","));
      }
    },
    LevelCreator_levelFromMap_closure3: {
      "^": "Closure:3;$this,level",
      call$2: function(k, v) {
        return this.$this.setPowerUp$3(this.level, k, J.split$1$s(J.toString$0$(v), ","));
      }
    },
    LevelCreator_levelFromMap_closure4: {
      "^": "Closure:3;$this,level",
      call$2: function(k, v) {
        return !J.$eq$(k, "speed") ? this.$this.setWalker$3(this.level, k, J.split$1$s(J.toString$0$(v), ",")) : "";
      }
    },
    LevelCreator_levelFromMap_closure5: {
      "^": "Closure:3;$this,level",
      call$2: function(k, v) {
        return !J.$eq$(k, "speed") ? this.$this.setJumper$3(this.level, k, J.split$1$s(J.toString$0$(v), ",")) : "";
      }
    },
    LevelCreator_levelFromMap_closure6: {
      "^": "Closure:3;$this,level",
      call$2: function(k, v) {
        return this.$this.setSlime$3(this.level, k, J.split$1$s(J.toString$0$(v), ","));
      }
    },
    LevelCreator_levelFromMap_closure7: {
      "^": "Closure:3;$this,level",
      call$2: function(k, v) {
        return !J.$eq$(k, "speed") ? this.$this.setPlayer$3(this.level, k, J.split$1$s(J.toString$0$(v), ",")) : "";
      }
    },
    LevelCreator_levelFromMap_closure8: {
      "^": "Closure:3;$this,level",
      call$2: function(k, v) {
        return this.$this.setAir$3(this.level, k, J.split$1$s(J.toString$0$(v), ","));
      }
    }
  }], ["", "lib/controller/MenuController.dart",, S, {
    "^": "",
    MenuController: {
      "^": "Object;view,gameController,selectedLevel",
      loadLevel$1: [function(level) {
        this.gameController = A.GameController$(this.view, level);
        this.view.showGame$0();
      }, "call$1", "get$loadLevel", 2, 0, 18],
      triggerBackToMenuFromSuccess$1: [function($event) {
        this.view.showMenu$0();
      }, "call$1", "get$triggerBackToMenuFromSuccess", 2, 0, 4],
      triggerBackToMenuFromFailure$1: [function($event) {
        this.view.showMenu$0();
      }, "call$1", "get$triggerBackToMenuFromFailure", 2, 0, 4],
      triggerShowCredits$1: [function($event) {
        var t1, t2, t3, t4, t5, t6, t7, t8;
        t1 = this.view;
        t1.isGameActive = false;
        t2 = t1.gameField;
        ...
        t1 = t1.style;
        t1.visibility = "hidden";
      }, "call$1", "get$triggerShowCredits", 2, 0, 4],
      triggerBackToMenuFromCredits$1: [function($event) {
        this.view.showMenu$0();
      }, "call$1", "get$triggerBackToMenuFromCredits", 2, 0, 4],
      triggerNextLevel$1: [function($event) {
        var t1 = this.selectedLevel;
        if (typeof t1 !== "number")
          return t1.$add();
        ++t1;
        this.selectedLevel = t1;
        new V.LevelCreator(100, 20, this.view).load$2(0, t1, this.get$loadLevel());
        this.view.showGame$0();
      }, "call$1", "get$triggerNextLevel", 2, 0, 4],
      triggerRetryLevel$1: [function($event) {
        var t1 = this.selectedLevel;
        new V.LevelCreator(100, 20, this.view).load$2(0, t1, this.get$loadLevel());
        this.view.showGame$0();
      }, "call$1", "get$triggerRetryLevel", 2, 0, 4]
    }
  }], ["", "lib/model/gameObjects/moveableGameObjects/MoveableGameObject.dart",, S, {
    "^": "",
    MoveableGameObject: {
      "^": "GameObject;",
      destroy$0: function() {
        ...
        t2 = t1[t2];
        t1 = this.positionX;
        t3 = this.currentStaticObject;
        if (t1 >>> 0 !== t1 || t1 >= t2.length)
          return H.ioore(t2, t1);
        t2[t1] = t3;
      }
    }
  }], ["", "lib/model/gameObjects/moveableGameObjects/Player.dart",, R, {
    "^": "",
    Player: {
      "^": "MoveableGameObject;secondLife,powerUp,movementSpeed,_isDestroyed,hasGravity,currentStaticObject,moveBehavior,jumpBehavior,attackBehavior,desiredX,desiredY,direction,level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
  }], ["", "lib/model/behaviors/PowerUp.dart",, B, {
    "^": "",
    PowerUp: {
  ...
  }], ["", "lib/model/gameObjects/PowerUpBlock.dart",, L, {
    "^": "",
    PowerUpBlock: {
      "^": "GameObject;level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
  }], ["", "lib/model/gameObjects/moveableGameObjects/Projectile.dart",, K, {
    "^": "",
    Projectile: {
      "^": "MoveableGameObject;movementSpeed,_isDestroyed,hasGravity,currentStaticObject,moveBehavior,jumpBehavior,attackBehavior,desiredX,desiredY,direction,level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
  }], ["", "lib/model/behaviors/attack/ProjectileAttack.dart",, D, {
    "^": "",
    ProjectileAttack: {
      "^": "IAttackBehavior;"
    }
  }], ["", "lib/model/behaviors/move/ProjectileMove.dart",, Y, {
    "^": "",
    ProjectileMove: {
      "^": "IMoveBehavior;",
      move$1: function(mgo) {
        var t1, t2, enemy;
        t1 = J.$add$ns(mgo.desiredX, mgo.direction);
        mgo.desiredX = t1;
        t2 = mgo.level;
        enemy = R.Enemy_getEnemyByPosition(t2, mgo.desiredY, t1);
        if (enemy != null) {
          enemy.destroy$0();
          mgo.destroy$0();
  ...
  }], ["", "lib/model/behaviors/jump/SimpleJump.dart",, N, {
    "^": "",
    SimpleJump: {
      "^": "IJumpBehavior;",
      jump$1: function(mgo) {
        ...
        if (t3[t1].isPassable)
          return;
        mgo.desiredY = J.$sub$n(mgo.desiredY, 2);
      }
    }
  }], ["", "lib/model/behaviors/move/SimpleMove.dart",, Z, {
    "^": "",
    SimpleMove: {
      "^": "IMoveBehavior;",
      move$1: function(mgo) {
        mgo.desiredX = J.$add$ns(mgo.desiredX, mgo.direction);
      }
    }
  }], ["", "lib/model/gameObjects/moveableGameObjects/Slime.dart",, D, {
    "^": "",
    Slime: {
      "^": "Enemy;movementSpeed,_isDestroyed,hasGravity,currentStaticObject,moveBehavior,jumpBehavior,attackBehavior,desiredX,desiredY,direction,level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
  }], ["", "lib/model/gameObjects/moveableGameObjects/Walker.dart",, D, {
    "^": "",
    Walker: {
      "^": "Enemy;movementSpeed,_isDestroyed,hasGravity,currentStaticObject,moveBehavior,jumpBehavior,attackBehavior,desiredX,desiredY,direction,level,positionX,positionY,isPassable,isDeathly,isGoal,tag"
    }
    ...
    "^": "",
    main: [function() {
      var mc = new S.MenuController(null, null, null);
      mc.view = L.GameView$(mc);
  ...
  C.Duration_2500000 = new P.Duration(2500000);
  ...
  C.PowerUp_0 = new B.PowerUp(0, "PowerUp.speed");
  C.PowerUp_1 = new B.PowerUp(1, "PowerUp.higherJump");
  C.PowerUp_2 = new B.PowerUp(2, "PowerUp.fire");
  C.PowerUp_3 = new B.PowerUp(3, "PowerUp.secondLife");
  C.PowerUp_4 = new B.PowerUp(4, "PowerUp.noPowerUp");
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [W.MouseEvent]}, {func: 1, args: [W.MouseEvent]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, v: true, args: [Q.Level]}];
